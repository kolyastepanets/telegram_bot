...
ActiveRecord::Schema.define(version: 2018_08_05_143637) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "user_youtube_channels", force: :cascade do |t|
    t.integer "user_id"
    t.integer "youtube_channel_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_user_youtube_channels_on_user_id"
    t.index ["youtube_channel_id"], name: "index_user_youtube_channels_on_youtube_channel_id"
  end
